...
button.addEventListener("click", ()=>{
    ...
    let file = new File([`<h1>${titulo}</h1></br></br><p>${descricao}</p></br></br><h2>instalação</h2>${instalacao}</br></br><h2>Modo de uso</h2>${uso}</br></br><h2>ajude você tambêm</h2>${contribuir}</br></br><h2>Licença</h2>${licenca}</br></br><h2>Créditos</h2>${creditos}</br></br><h2>Um pouco mais</h2>${mais}`], 'README.md',{type: "text/plain;charset=utf-8"})
